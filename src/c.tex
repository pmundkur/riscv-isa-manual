...
\begin{formalcomment}
  ...
  and the RV128C instructions are not present in this and subsequent
  Sail listings.
\end{formalcomment}

\mbox{}
\begin{formalspec}
  \sailfclCUnderscoreLWSPexecute
  \sailfclCUnderscoreLDSPexecute
  \sailfclCUnderscoreFLWSPexecute
  \sailfclCUnderscoreFLDSPexecute
\end{formalspec}
...
\begin{formalspec}
  \sailfclCUnderscoreSWSPexecute
  \sailfclCUnderscoreSDSPexecute
  \sailfclCUnderscoreFSWSPexecute
  \sailfclCUnderscoreFSDSPexecute
\end{formalspec}
...
\begin{formalspec}
  \sailfclCUnderscoreLWexecute
  \sailfclCUnderscoreLDexecute
  \sailfclCUnderscoreFLWexecute
  \sailfclCUnderscoreFLDexecute
\end{formalspec}
...
\begin{formalspec}
  \sailfclCUnderscoreSWexecute
  \sailfclCUnderscoreSDexecute
  \sailfclCUnderscoreFSWexecute
  \sailfclCUnderscoreFSDexecute
\end{formalspec}
...
\begin{formalspec}
  \sailfclCUnderscoreJRexecute
  \sailfclCUnderscoreJALRexecute
\end{formalspec}
...
\begin{formalspec}
  \sailfclCUnderscoreBEQZexecute
  \sailfclCUnderscoreBNEZexecute
\end{formalspec}
...
\begin{formalspec}
  \sailfclCUnderscoreLIexecute
  \sailfclCUnderscoreLUIexecute
\end{formalspec}
...
\begin{formalspec}
  \sailfclCUnderscoreADDIexecute
  \sailfclCUnderscoreADDIWexecute
  \sailfclCUnderscoreADDIOneSixSPexecute
\end{formalspec}
...
\begin{formalspec}
  \sailfclCUnderscoreADDIFourSPNexecute
\end{formalspec}
...
\begin{formalspec}
  \sailfclCUnderscoreSRLIexecute
  \sailfclCUnderscoreSRAIexecute
\end{formalspec}
...
\begin{formalspec}
  \sailfclCUnderscoreMVexecute
  \sailfclCUnderscoreADDexecute
\end{formalspec}
...
\begin{formalspec}
  \sailfclCUnderscoreANDexecute
  \sailfclCUnderscoreORexecute
  \sailfclCUnderscoreXORexecute
  \sailfclCUnderscoreSUBexecute
  \sailfclCUnderscoreADDWexecute
  \sailfclCUnderscoreSUBWexecute
\end{formalspec}
...
\begin{formalspec}
  \sailfclCUnderscoreILLEGALexecute
\end{formalspec}
...
\begin{formalspec}
  \sailfclCUnderscoreEBREAKexecute
\end{formalspec}
