...
\begin{formalcomment}
  See the note on page~\pageref{ssec:sail:fp} on floating point in the
  Sail specification.
\end{formalcomment}
...
\begin{formalcomment}
  This handling of NaN-boxing is performed in the Sail model by
  \sailfname{nan\_box} and \sailfname{nan\_unbox}.
\end{formalcomment}
...
\begin{formalcomment}
  The formal definitions of FLD and FSD are handled by the version for
  the F extension given on page~\pageref{lbl:fldst32}.
\end{formalcomment}
...
\begin{formalspec}
  \sailfclFUnderscoreBINUnderscoreRMUnderscoreTYPEUnderscoreDexecute
  \sailfclFUnderscoreBINUnderscoreTYPEUnderscoreDCexecute
  \sailfclFUnderscoreBINUnderscoreTYPEUnderscoreDDexecute
  \sailfclFUnderscoreUNUnderscoreRMUnderscoreTYPEUnderscoreDexecute
\end{formalspec}
...
\begin{formalspec}
  \sailfclFUnderscoreMADDUnderscoreTYPEUnderscoreDexecute
\end{formalspec}
...
\begin{formalspec}
  \sailfclFUnderscoreUNUnderscoreRMUnderscoreTYPEUnderscoreDAexecute
  \sailfclFUnderscoreUNUnderscoreRMUnderscoreTYPEUnderscoreDBexecute
  \sailfclFUnderscoreUNUnderscoreRMUnderscoreTYPEUnderscoreDCexecute
  \sailfclFUnderscoreUNUnderscoreRMUnderscoreTYPEUnderscoreDDexecute
  \sailfclFUnderscoreUNUnderscoreRMUnderscoreTYPEUnderscoreDGexecute
  \sailfclFUnderscoreUNUnderscoreRMUnderscoreTYPEUnderscoreDHexecute
  \sailfclFUnderscoreUNUnderscoreRMUnderscoreTYPEUnderscoreDIexecute
  \sailfclFUnderscoreUNUnderscoreRMUnderscoreTYPEUnderscoreDJexecute
\end{formalspec}
...
\begin{formalspec}
  \sailfclFUnderscoreUNUnderscoreRMUnderscoreTYPEUnderscoreDEexecute
  \sailfclFUnderscoreUNUnderscoreRMUnderscoreTYPEUnderscoreDFexecute
\end{formalspec}
...
\begin{formalspec}
  \sailfclFUnderscoreBINUnderscoreTYPEUnderscoreDexecute
  \sailfclFUnderscoreBINUnderscoreTYPEUnderscoreDAexecute
  \sailfclFUnderscoreBINUnderscoreTYPEUnderscoreDBexecute
\end{formalspec}
...
\begin{formalspec}
  \sailfclFUnderscoreUNUnderscoreTYPEUnderscoreDAexecute
  \sailfclFUnderscoreUNUnderscoreTYPEUnderscoreDBexecute
\end{formalspec}
...
\begin{formalspec}
  \sailfclFUnderscoreUNUnderscoreTYPEUnderscoreDexecute
\end{formalspec}
