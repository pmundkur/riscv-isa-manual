...
\begin{addformalcomment}
  The role played by {\tt mstatus} in traps and privilege transition in the formal Sail model is described in \S\ref{s:priv-sail-traps}.
...
\begin{addformalcomment}
  The handling of memory privilege in {\tt mstatus} in the Sail formal
  model can be seen in \S\ref{ss:priv-sail-ptes} and in the
  \sailfname{translateAddr} function in
  \S\ref{ss:priv-sail-addr-trans}.
\end{addformalcomment}
...
\begin{addformalcomment}
  The role played by TW and TSR in the Sail model can be seen in
  \S\ref{s:priv-sail-traps}, and that of TVM in \S\ref{s:priv-sail-csr-access}.
\end{addformalcomment}
...
\begin{addformalcomment}
  The Sail specification of the handling of the {\tt mtvec} register
  is in \S\ref{s:priv-sail-tvecs}.
\end{addformalcomment}
...
\begin{addformalcomment}
  The specification of interrupt and exception delegation in the Sail formal model is in \S\ref{s:priv-sail-intrs} and \S\ref{s:priv-sail-traps}.
\end{addformalcomment}
...
\begin{addformalcomment}
  The processing of the {\tt mip} and {\tt mie} registers in the Sail
  model is specified in \S\ref{s:priv-sail-intrs}.
\end{addformalcomment}
...
\begin{addformalcomment}
  The use of {\tt mepc} in the Sail model is specified in
  \S\ref{s:priv-sail-tvecs} and \S\ref{s:priv-sail-traps}.
\end{addformalcomment}
...
\begin{addformalcomment}
  The use of {\tt mtval} in the Sail model is specified in
  \S\ref{s:priv-sail-tvecs} and \S\ref{s:priv-sail-traps}.
\end{addformalcomment}
...
\end{formalspec}
\begin{addformalcomment}
  The \sailfname{platform\_wfi} function here implements a
  platform-specific WFI semantics.
\end{addformalcomment}
