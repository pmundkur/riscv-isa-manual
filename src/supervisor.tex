...
they are marked \wpri\ in Figures~\ref{sipreg} and \ref{siereg}.
\end{commentary}
...
\begin{formalspec}
  \sailfclSFENCEUnderscoreVMAexecute
\end{formalspec}
\begin{formalcomment}
  The \sailfname{flush\_TLB} function is not described in the Sail
  model included in this document, since the specification leaves the
  details of a TLB unspecified.
\end{formalcomment}
...
\begin{addformalcomment}
  The handling of PTEs in the Sail model is specified in \S\ref{ss:priv-sail-ptes}.
...
\begin{addformalcomment}
  The Sail specification of the Sv39 address translation scheme is in
  \S\ref{ss:priv-sail-addr-trans}.  We do not include the Sail
  specifications of the Sv32 and Sv48 schemes in this document since
